#!/usr/bin/env python3
"""
Step 1: Download CHIRPS Precipitation Data for Rwanda (2016-2017)
...
print("="*70)
print("DOWNLOAD CHIRPS PRECIPITATION DATA - RWANDA (2016-2017)")
print("="*70)
...
print(f"Period: 2016-01-01 to 2017-12-31 (730 days)")
...
while current_date <= end_date:
    ...
    if len(downloaded) % 50 == 0:
        ...
        print(f"\n  Progress: {len(downloaded)}/730 files ({elapsed/60:.1f} minutes elapsed)")
...
print("\n" + "="*70)
print("NEXT STEP: Download ERA5 data using 02_download_era5_rwanda.py")
print("="*70)
