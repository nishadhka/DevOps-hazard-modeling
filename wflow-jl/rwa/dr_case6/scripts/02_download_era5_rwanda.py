#!/usr/bin/env python3
"""
Step 2: Download ERA5 Climate Data for Rwanda (2016-2017)

ERA5: ECMWF Reanalysis v5 (Temperature and PET)
Source: Copernicus Climate Data Store (CDS)
Period: 2016-01-01 to 2017-12-31
...
print("="*70)
print("DOWNLOAD ERA5 CLIMATE DATA - RWANDA (2016-2017)")
print("="*70)
...
print(f"Region: Rwanda ({RWANDA_BOUNDS['west']}, {RWANDA_BOUNDS['south']}) to ({RWANDA_BOUNDS['east']}, {RWANDA_BOUNDS['north']})")
print(f"Period: 2016-01-01 to 2017-12-31")
    ...
    try:
        c.retrieve(
            'reanalysis-era5-single-levels',
            {
                ...
                'area': [
                    RWANDA_BOUNDS['north'], RWANDA_BOUNDS['west'],
                    RWANDA_BOUNDS['south'], RWANDA_BOUNDS['east'],
                ],
                'format': 'netcdf',
            },
            output_file
...
temp_file = ERA5_DIR / 'temperature_2m_2016_2017.nc'
...
pet_file = ERA5_DIR / 'potential_evaporation_2016_2017.nc'
...
pressure_file = ERA5_DIR / 'surface_pressure_2016_2017.nc'
