#!/usr/bin/env python3
"""
Step 3: Prepare Wflow Forcing File (forcing.nc) for Kenya
...
print("=" * 70)
print("PREPARE WFLOW FORCING FILE - KENYA (2020-2023) - YEAR WISE")
print("=" * 70)
...
for year in YEARS:
    ...
    forcing_y.attrs["title"] = f"Wflow forcing - Kenya - {year}"
