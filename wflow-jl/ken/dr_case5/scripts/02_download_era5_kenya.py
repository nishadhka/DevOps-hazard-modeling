#!/usr/bin/env python3
"""
Step 2: Download ERA5 Climate Data for Kenya (2020-2023)
...
print("="*70)
print("DOWNLOAD ERA5 CLIMATE DATA - KENYA (2020-2023)")
print("="*70)
    ...
    try:
        c.retrieve(
            'reanalysis-era5-single-levels',
            {
                ...
                'area': [
                    KENYA_BOUNDS['north'], KENYA_BOUNDS['west'],
                    KENYA_BOUNDS['south'], KENYA_BOUNDS['east'],
                ],
                'format': 'netcdf',
            },
            output_file
...
print("\n" + "="*70)
print("NEXT STEP: Prepare forcing.nc for Wflow using 03_prepare_forcing_kenya.py")
print("="*70)
