#!/usr/bin/env python3
"""
Derive complete Wflow staticmaps for Kenya from 10 raw GeoTIFF inputs.
...
# Monthly LAI multipliers for semi-arid climate (Kenya)
monthly_lai_factor = [
...
# Snow parameters (Kenya has highlands with occasional snow)
