#!/usr/bin/env python3
"""
Step 1: Download CHIRPS Precipitation Data for Uganda (2021-2022)

CHIRPS: Climate Hazards Group InfraRed Precipitation with Station data
Source: https://data.chc.ucsb.edu/products/CHIRPS-2.0/
Period: 2021-01-01 to 2022-12-31 (730 days)
...
print("="*70)
print("DOWNLOAD CHIRPS PRECIPITATION DATA - UGANDA (2021-2022)")
print("="*70)
...
print(f"Period: 2021-01-01 to 2022-12-31 (730 days)")
...
print("\n" + "="*70)
print("NEXT STEP: Download ERA5 data using 02_download_era5_uganda.py")
print("="*70)
