#!/usr/bin/env python3
"""
Derive complete Wflow staticmaps for Eritrea from 10 raw GeoTIFF inputs.
...
Input: wflow_datasets_1km/*.tif (10 GeoTIFF files)
Output: data/input/staticmaps.nc

Usage:
    python3 derive_staticmaps_eritrea.py
"""
...
print("=" * 80)
print("GENERATING WFLOW STATICMAPS FOR ERITREA")
print("=" * 80)

# # =============================================================================
# 1. LOAD RAW DATA
# =============================================================================
print("\nSTEP 1: Loading raw Eritrea GeoTIFF data...")                        

# Use absolute paths
base_dir = Path("/Users/sinugp/Desktop/Personal/Documents2/Nishadh/Xee/Final_Simulation_Drought/03_Eritrea_2021_2023")
data_dir = base_dir / "wflow_datasets_1km"                                               
output_dir = base_dir / "data/input"                                               
...
# Add attributes                                                              
ds.attrs['title'] = 'Wflow staticmaps for Eritrea'                            
