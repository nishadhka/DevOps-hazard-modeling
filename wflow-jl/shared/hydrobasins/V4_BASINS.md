...
| 04 | ETH | Blue Nile / Abbay | 4 | basin | 34.95,11.13 | 200,000 | 308,197 | 928×815 | ❌ ldd-cycle (see ETH_BLOCK.md) |
| 05 | KEN | Tana | 4 | basin | 40.30,-2.40 | 95,000 | 95,249 | 393×446 | ✅ |
| 06 | RWA | Lower Akagera | 6 | basin | 30.79,-2.38 | 25,000 | 18,488 | 186×173 | ✅ |
| 07 | SOM | Juba-Shabelle (combined) | 4 | basin | 42.55,-0.36 | 810,000 | 797,881 | 1119×1096 | ✅ |
...
**Run status (2026-05-18):** **10/11 WRSI grids complete**
(`<iso>/output/output_grid_wrsi.nc`); SOM done (479 MB), **ETH is the
sole open case** — persistent ldd-cycle, IHU rework pending
(`ETH_BLOCK.md`). The large/endorheic cases needed median-fill repair
of soil/river NaN + `pyflwdir.from_dem` ldd rebuild (cycle-free) before
wflow ran.
