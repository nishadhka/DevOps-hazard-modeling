#!/usr/bin/env python3
"""
Step 1: Download CHIRPS Precipitation Data for Djibouti (2021-2023)
...
print("="*70)
print("DOWNLOAD CHIRPS PRECIPITATION DATA - DJIBOUTI (2021-2023)")
print("="*70)
...
print(f"Period: 2021-01-01 to 2023-12-31 (1095 days)")
...
while current_date <= end_date:
    ...
    if len(downloaded) % 50 == 0:
        ...
        print(f"\n  Progress: {len(downloaded)}/1095 files ({elapsed/60:.1f} minutes elapsed)")
...
print("\n" + "="*70)
print("NEXT STEP: Download ERA5 data using 02_download_era5_djibouti.py")
print("="*70)
