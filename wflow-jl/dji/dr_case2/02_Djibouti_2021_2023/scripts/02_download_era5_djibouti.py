#!/usr/bin/env python3
"""
Step 2: Download ERA5 Climate Data for Djibouti (2021-2023)
...
print("="*70)
print("DOWNLOAD ERA5 CLIMATE DATA - DJIBOUTI (2021-2023)")
print("="*70)
...
print(f"Region: Djibouti ({DJIBOUTI_BOUNDS['west']}, {DJIBOUTI_BOUNDS['south']}) to ({DJIBOUTI_BOUNDS['east']}, {DJIBOUTI_BOUNDS['north']})")
    ...
    try:
        c.retrieve(
            'reanalysis-era5-single-levels',
            {
                ...
                'area': [
                    DJIBOUTI_BOUNDS['north'], DJIBOUTI_BOUNDS['west'],
                    DJIBOUTI_BOUNDS['south'], DJIBOUTI_BOUNDS['east'],
                ],
                'format': 'netcdf',
            },
            output_file
...
print("This will take 60-90 minutes total (20-30 minutes per year)...")
...
temp_file = ERA5_DIR / 'temperature_2m_2021_2023.nc'
...
pet_file = ERA5_DIR / 'potential_evaporation_2021_2023.nc'
...
pressure_file = ERA5_DIR / 'surface_pressure_2021_2023.nc'
