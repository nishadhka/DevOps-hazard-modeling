#!/usr/bin/env python3
"""
Step 1: Download CHIRPS Precipitation Data for Ethiopia (2020-2023)
...
print("="*70)
print("DOWNLOAD CHIRPS PRECIPITATION DATA - ETHIOPIA (2020-2023)")
print("="*70)
...
print("\n" + "="*70)
print("NEXT STEP: Download ERA5 data using 02_download_era5_ethiopia.py")
print("="*70)
