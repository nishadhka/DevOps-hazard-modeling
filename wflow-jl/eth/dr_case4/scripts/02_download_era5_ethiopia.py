#!/usr/bin/env python3
"""
Step 2: Download ERA5 Climate Data for Ethiopia (2020-2023)
...
print("="*70)
print("DOWNLOAD ERA5 CLIMATE DATA - ETHIOPIA (2020-2023)")
print("="*70)
...
print(f"Region: Ethiopia ({ETHIOPIA_BOUNDS['west']}, {ETHIOPIA_BOUNDS['south']}) to ({ETHIOPIA_BOUNDS['east']}, {ETHIOPIA_BOUNDS['north']})")
    ...
    try:
        c.retrieve(
            'reanalysis-era5-single-levels',
            {
                ...
                'area': [
                    ETHIOPIA_BOUNDS['north'], ETHIOPIA_BOUNDS['west'],
                    ETHIOPIA_BOUNDS['south'], ETHIOPIA_BOUNDS['east'],
                ],
                'format': 'netcdf',
            },
            output_file
...
print("This will take 80-120 minutes total (20-30 minutes per year)...")
...
temp_file = ERA5_DIR / 'temperature_2m_2020_2023.nc'
...
pet_file = ERA5_DIR / 'potential_evaporation_2020_2023.nc'
...
pressure_file = ERA5_DIR / 'surface_pressure_2020_2023.nc'
...
print("\n" + "="*70)
print("NEXT STEP: Prepare forcing.nc for Wflow using 03_prepare_forcing_ethiopia.py")
print("="*70)
