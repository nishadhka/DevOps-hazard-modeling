#!/usr/bin/env python3
"""
RIM2D v1 setup — Somalia South
=======================================================
Event:   2023-11-19 to 2023-11-21
Country: SOM
Bbox:    lon [45.15, 45.45]  lat [1.9, 2.2]
Desc:    Flash flood, southern Somalia
...
BBOX = {"lon_min": 45.15, "lat_min": 1.9,
         "lon_max": 45.45, "lat_max": 2.2}
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — Somalia South")
    print(f"  Bbox: {BBOX}")
