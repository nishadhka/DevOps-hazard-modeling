#!/usr/bin/env python3
"""
RIM2D v1 setup — South Sudan Upper Nile
=======================================================
Event:   2019-10-15 to 2019-12-15
Country: SSD
Bbox:    lon [31.45, 31.75]  lat [4.7, 5.0]
Desc:    Seasonal flood, Upper Nile State
...
BBOX = {"lon_min": 31.45, "lat_min": 4.7,
         "lon_max": 31.75, "lat_max": 5.0}

EVENT_START = "2019-10-15"
EVENT_END   = "2019-12-15"
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — South Sudan Upper Nile")
    print(f"  Bbox: {BBOX}")
