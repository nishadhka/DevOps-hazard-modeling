...
V21_INPUT = WORK_DIR / "v21" / "input"
DEM_TIF   = V21_INPUT / "dem_v21.tif"
DEM_NC    = V21_INPUT / "dem_v21.nc"
...
fig.suptitle("v21 DEM Diagnostic — Terrain Analysis Before Simulation", fontsize=14, fontweight="bold")
fig.tight_layout()
out = VIZ_DIR / "v21_dem_diagnostic_terrain.png"
...
fig.tight_layout()
out = VIZ_DIR / "v21_dem_diagnostic_flowpaths.png"
fig.savefig(out, dpi=DPI, bbox_inches="tight", facecolor="white")
plt.close(fig)
print(f"  Saved: {out.name}")
...
fig.suptitle("DEM Cross-Sections at Key Columns — Connectivity Check",
             fontsize=13, fontweight="bold")
fig.tight_layout()
out = VIZ_DIR / "v21_dem_diagnostic_crosssections.png"
fig.savefig(out, dpi=DPI, bbox_inches="tight", facecolor="white")
plt.close(fig)
print(f"  Saved: {out.name}")
