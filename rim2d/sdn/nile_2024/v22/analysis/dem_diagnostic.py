...
V22_INPUT = WORK_DIR / "v22" / "input"
DEM_TIF   = V22_INPUT / "dem_v22.tif"
DEM_NC    = V22_INPUT / "dem_v22.nc"
GEOJSON   = WORK_DIR / "v11" / "input" / "river_network_tdx_v2.geojson"
VIZ_DIR   = WORK_DIR / "v22" / "analysis" / "visualizations"
...
fig.suptitle("v22 DEM Diagnostic — Terrain Analysis Before Simulation", fontsize=14, fontweight="bold")
fig.tight_layout()
out = VIZ_DIR / "v22_dem_diagnostic_terrain.png"
...
fig.tight_layout()
out = VIZ_DIR / "v22_dem_diagnostic_flowpaths.png"
fig.savefig(out, dpi=DPI, bbox_inches="tight", facecolor="white")
plt.close(fig)
print(f"  Saved: {out.name}")
...
fig.suptitle("DEM Cross-Sections at Key Columns — Connectivity Check",
             fontsize=13, fontweight="bold")
fig.tight_layout()
out = VIZ_DIR / "v22_dem_diagnostic_crosssections.png"
fig.savefig(out, dpi=DPI, bbox_inches="tight", facecolor="white")
plt.close(fig)
print(f"  Saved: {out.name}")
