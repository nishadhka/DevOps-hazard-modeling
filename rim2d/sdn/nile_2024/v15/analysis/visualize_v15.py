#!/usr/bin/env python3
"""
v15 RIM2D output — animation + analysis
=========================================
...
Usage:
    micromamba run -n zarrv3 python analysis/visualize_v15.py
"""
...
OUT_DIR   = Path("/data/rim2d/nile_highres/v15/output")
...
def plot_max_depth(wd_max, dem, x, y):
    ...
    ax.set_title(
        f"v15 — Peak flood depth | Abu Hamad, Aug 25–31 2024\n"
    ...
    fig.tight_layout()
    out = VIZ_DIR / "v15_max_depth_map.png"
...
def plot_timeseries(snaps):
    ...
    axes[0].set_title("v15 — Flood evolution (Aug 25–31, 6-day window)", fontsize=10)
    ...
    fig.tight_layout()
    out = VIZ_DIR / "v15_timeseries.png"
...
def print_analysis(wd_max):
    ...
    print("\n" + "=" * 72)
    print(f"{'Metric':<35} {'v11':>8} {'v12':>8} {'v14':>8} {'v15':>8}")
    print("-" * 72)
    rows = [
...
if __name__ == "__main__":
    ...
    print("Loading v15 output ...")
    wd_max, _, _ = load_nc(OUT_DIR / "nile_v15_wd_max.nc")
