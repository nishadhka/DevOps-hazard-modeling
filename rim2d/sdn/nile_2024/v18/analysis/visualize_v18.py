#!/usr/bin/env python3
"""
v18 RIM2D output — animation + analysis
=========================================
...
Usage:
    micromamba run -n zarrv3 python analysis/visualize_v18.py
"""
...
OUT_DIR   = Path("/data/rim2d/nile_highres/v18/output")
VIZ_DIR   = Path("/data/rim2d/nile_highres/v18/analysis/visualizations")
...
def plot_max_depth(wd_max, dem, x, y):
    ...
    ax.set_title(
        f"v18 — Peak flood depth | Abu Hamad, Aug 25–31 2024\n"
    ...
    fig.tight_layout()
    out = VIZ_DIR / "v18_max_depth_map.png"
...
def plot_timeseries(snaps):
    ...
    axes[0].set_title("v18 — Flood evolution (Aug 25–31, 6-day window)", fontsize=10)
    ...
    fig.tight_layout()
    out = VIZ_DIR / "v18_timeseries.png"
...
def print_analysis(wd_max):
    ...
    print("\n" + "=" * 72)
    print(f"{'Metric':<35} {'v11':>8} {'v12':>8} {'v14':>8} {'v18':>8}")
    print("-" * 72)
    rows = [
...
if __name__ == "__main__":
    ...
    print("Loading v18 output ...")
    wd_max, _, _ = load_nc(OUT_DIR / "nile_v18_wd_max.nc")
