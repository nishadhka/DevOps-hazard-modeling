...
DEM_TIF   = V23_INPUT / "dem_v23.tif"
DEM_NC    = V23_INPUT / "dem_v23.nc"
GEOJSON   = WORK_DIR / "v11" / "input" / "river_network_tdx_v2.geojson"
VIZ_DIR   = WORK_DIR / "v23" / "analysis" / "visualizations"
...
fig.tight_layout()
out = VIZ_DIR / "v23_dem_diagnostic_terrain.png"
...
fig.tight_layout()
out = VIZ_DIR / "v23_dem_diagnostic_flowpaths.png"
fig.savefig(out, dpi=DPI, bbox_inches="tight", facecolor="white")
plt.close(fig)
print(f"  Saved: {out.name}")
...
fig.suptitle("DEM Cross-Sections at Key Columns — Connectivity Check",
             fontsize=13, fontweight="bold")
fig.tight_layout()
out = VIZ_DIR / "v23_dem_diagnostic_crosssections.png"
fig.savefig(out, dpi=DPI, bbox_inches="tight", facecolor="white")
plt.close(fig)
print(f"  Saved: {out.name}")
