#!/usr/bin/env python3
"""
v17 RIM2D output — animation + analysis
=========================================
...
Usage:
    micromamba run -n zarrv3 python analysis/visualize_v17.py
"""
...
OUT_DIR   = Path("/data/rim2d/nile_highres/v17/output")
VIZ_DIR   = Path("/data/rim2d/nile_highres/v17/analysis/visualizations")
...
def plot_max_depth(wd_max, dem, x, y):
    ...
    ax.set_title(
        f"v17 — Peak flood depth | Abu Hamad, Aug 25–31 2024\n"
    ...
    fig.tight_layout()
    out = VIZ_DIR / "v17_max_depth_map.png"
...
def plot_timeseries(snaps):
    ...
    axes[0].set_title("v17 — Flood evolution (Aug 25–31, 6-day window)", fontsize=10)
    ...
    fig.tight_layout()
    out = VIZ_DIR / "v17_timeseries.png"
...
def print_analysis(wd_max):
    ...
    print("\n" + "=" * 72)
    print(f"{'Metric':<35} {'v11':>8} {'v12':>8} {'v14':>8} {'v17':>8}")
    print("-" * 72)
    rows = [
...
if __name__ == "__main__":
    ...
    print("Loading v17 output ...")
    wd_max, _, _ = load_nc(OUT_DIR / "nile_v17_wd_max.nc")
