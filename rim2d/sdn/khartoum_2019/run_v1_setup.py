#!/usr/bin/env python3
"""
RIM2D v1 setup — Khartoum Omdurman
=======================================================
Event:   2019-08-01 to 2019-09-10
Country: SDN
Bbox:    lon [32.2, 32.8]  lat [15.3, 15.9]
Desc:    Flash flood, Khartoum / Omdurman / Bahri
...
BBOX = {"lon_min": 32.2, "lat_min": 15.3,
         "lon_max": 32.8, "lat_max": 15.9}

EVENT_START = "2019-08-01"
EVENT_END   = "2019-09-10"
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — Khartoum Omdurman")
    print(f"  Bbox: {BBOX}")
