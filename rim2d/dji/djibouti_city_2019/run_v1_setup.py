#!/usr/bin/env python3
"""
RIM2D v1 setup — Djibouti City
=======================================================
Event:   2019-11-21 to 2019-11-23
Country: DJI
Bbox:    lon [42.5, 43.3]  lat [11.4, 11.8]
Desc:    Flash flood, Djibouti City urban area
...
BBOX = {"lon_min": 42.5, "lat_min": 11.4,
         "lon_max": 43.3, "lat_max": 11.8}

EVENT_START = "2019-11-21"
EVENT_END   = "2019-11-23"
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — Djibouti City")
    print(f"  Bbox: {BBOX}")
