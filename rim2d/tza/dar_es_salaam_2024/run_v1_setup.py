#!/usr/bin/env python3
"""
RIM2D v1 setup — Dar es Salaam Urban
=======================================================
Event:   2024-04-10 to 2024-04-17
Country: TZA
Bbox:    lon [39.05, 39.45]  lat [-7.05, -6.6]
Desc:    Urban flood, Dar es Salaam
...
BBOX = {"lon_min": 39.05, "lat_min": -7.05,
         "lon_max": 39.45, "lat_max": -6.6}
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — Dar es Salaam Urban")
    print(f"  Bbox: {BBOX}")
