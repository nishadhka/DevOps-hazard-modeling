#!/usr/bin/env python3
"""
RIM2D v1 setup — Burundi National
=======================================================
Event:   2024-04-01 to 2024-04-22
Country: BDI
Bbox:    lon [29.2, 29.5]  lat [-3.55, -3.15]
Desc:    Seasonal flood, Burundi highlands
...
BBOX = {"lon_min": 29.2, "lat_min": -3.55,
         "lon_max": 29.5, "lat_max": -3.15}
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — Burundi National")
    print(f"  Bbox: {BBOX}")
