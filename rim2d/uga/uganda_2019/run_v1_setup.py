#!/usr/bin/env python3
"""
RIM2D v1 setup — Uganda Central
=======================================================
Event:   2019-05-26 to 2019-05-28
Country: UGA
Bbox:    lon [32.35, 32.85]  lat [0.2, 0.55]
Desc:    Flash flood, central Uganda (near Kampala)
...
BBOX = {"lon_min": 32.35, "lat_min": 0.2,
         "lon_max": 32.85, "lat_max": 0.55}

EVENT_START = "2019-05-26"
EVENT_END   = "2019-05-28"
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — Uganda Central")
    print(f"  Bbox: {BBOX}")
