#!/usr/bin/env python3
"""
RIM2D v1 setup — Kenya Central Nairobi
=======================================================
Event:   2024-04-24 to 2024-04-25
Country: KEN
Bbox:    lon [36.6, 37.1]  lat [-1.402, -1.098]
Desc:    Flash flood, Nairobi metropolitan area
...
BBOX = {"lon_min": 36.6, "lat_min": -1.402,
         "lon_max": 37.1, "lat_max": -1.098}

EVENT_START = "2024-04-24"
EVENT_END   = "2024-04-25"
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — Kenya Central Nairobi")
    print(f"  Bbox: {BBOX}")
