#!/usr/bin/env python3
"""
RIM2D v1 setup — Addis Akaki River
=======================================================
Event:   2021-08-16 to 2021-08-18
Country: ETH
Bbox:    lon [38.6, 38.9]  lat [8.8, 9.1]
Desc:    River flood, Akaki river, Addis Ababa
...
BBOX = {"lon_min": 38.6, "lat_min": 8.8,
         "lon_max": 38.9, "lat_max": 9.1}

EVENT_START = "2021-08-16"
EVENT_END   = "2021-08-18"
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — Addis Akaki River")
    print(f"  Bbox: {BBOX}")
