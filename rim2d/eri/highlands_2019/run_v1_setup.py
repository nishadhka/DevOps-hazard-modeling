#!/usr/bin/env python3
"""
RIM2D v1 setup — Eritrea Highlands
=======================================================
Event:   2019-08-10 to 2019-08-15
Country: ERI
Bbox:    lon [38.88, 39.05]  lat [15.25, 15.4]
Desc:    Flash flood, Eritrea highlands
...
BBOX = {"lon_min": 38.88, "lat_min": 15.25,
         "lon_max": 39.05, "lat_max": 15.4}

EVENT_START = "2019-08-10"
...
if __name__ == "__main__":
    print(f"RIM2D v1 setup — Eritrea Highlands")
    print(f"  Bbox: {BBOX}")
